<?php
// src/SkyResource/GetJobInGermanyBundle/DataFixtures/ORM/JobFixtures.php

namespace SkyResource\GetJobInGermanyBundle\DataFixtures\ORM;
...
class JobFixtures extends AbstractFixture implements FixtureInterface
{
